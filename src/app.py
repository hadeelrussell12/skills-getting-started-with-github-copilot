...
activities = {
    ...
    "Art Studio": {
        "description": "Painting, drawing, and sculpture in a creative studio setting",
    ...
    "Math Olympiad": {
        "description": "Prepare for math competitions with problem-solving strategies",
        "schedule": "Tuesdays, 3:45 PM - 4:45 PM",
        "max_participants": 15,
